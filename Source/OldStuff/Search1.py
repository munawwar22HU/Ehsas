...
class RTree:
    ...
    #                     continue
    #                 else:
    #                     if i[1].Pointer[0][1] == None: #[(),Node]  [[(),[]],[(),[]]]
    #                         print(self.IsLeaf(i[1]),"lol")
    #                         lst.append(i[1].Pointer[0][0])
    #                     elif a[1].Pointer[1] == None:  # a.Pointer.EntryList[1] = None
    #                         print(a[1].Pointer[0][0])
    #                         print(self.IsLeaf(a[1]),"lol1")
    #                         lst.append(a[1].Pointer[0][0]) # a.Pointer.EntryList[0].mbr
    #                     self.Search(a[1], value, lst)
    #         else:  # if leaf
    #             for i in root.Pointer:
    #                 if i[0] not in lst and i[0][0][0] >= value[0][0] and i[0][0][1] <= value[0][1] and i[0][1][0] >= value[1][0] and i[0][1][1] <= value[1][1]:
    #                     lst.append(i[0])
    #     return lst
...
print(tree.IsLeaf(tree.Root.Pointer[0][1].Pointer[0][1]))
print(tree.Root.Pointer[1][1].Pointer)

print(tree.IsLeaf(tree.Root.Pointer[1][1].Pointer[0][1]))
print(tree.IsLeaf(tree.Root.Pointer[1][1].Pointer[1][1]))

print(tree.Search(tree.Root, ([1,7], [1,5 ])))
